...
1- cards on events page
2- interactive zoom on store products
3- drop-down on navbar (for teams)
4- drop-down menu for mobile users
5- modal pop-out for articles and team-based galleries
...
### First Time Visitor Goals
 ...
 1- As a First Time Visitor, I want to locate their social media links to see their followings on social media to determine how trusted and known they are.
    ...
    2. When a user selects a social media link, they will be redirected in a new tab to the social media link.
    
 2- As a First Time Visitor, I also expect a clear and prominent "Ask us a question" form on the home page to assist me in case I have any questions or need support while navigating the website.
    1. Once the new visitor has read the About The Team and About Our CEO sections, they will notice the Ask Us A Question section.
    2. When a new visitor fills out the question form, they will be re-directed to the confirmation page.
    3. When a user fills out the form with invalid input data, they will receive an error pop up message.

 3- As a First Time Visitor, I want to easily understand the main purpose of the site and learn more about the organisation.
    1. The user will open the homepage and be able to read about the ogranization and CEO, as well as recent news for the organization.
    2. When the user selects Read More on an article to understand better a news article, they will be prompted with a pop-up modal for each article.
    
 4- As a First Time Visitor, I want to be able to easily navigate throughout the site to find content.        
    1. The user will be able to navigate through the site using the navigation bar at the top of the page.
    2. The navigation bar has an underline on whatever page they're on to help make it clear where they are at that current moment.
    3. At the bottom of the article pages and Subscription / Question confirmation pages, there is a 'Return Home' button.

### Returning Visitor Goals

1- As a returning User, I want to sign up to the Newsletter so that I am emailed any major updates and/or changes to the organisation or it's teams.
    1. When a user signs up to the newsletter using the form, they will be redirected to the confirmation page.
    2. The confirmation page will have a clear 'Return Home' button and a message that re-assures the user of confirmation that they've subscribed.
    3. When a user inputs invalid data in the form, they will be given a pop-up form error above the field to assist them.

2- As a returning user of Team Endalex's portfolio website, I want to see the latest updates on the teams' performances in Counter Strike, PUBG, and Rocket League on the home page. The "Ask us a question" form should still be readily available on the home page in case I require any assistance during my visit.
    1. On the homepage, there are three clear articles with images to attract users.
    2. The articles have the first paragraph of content and then a 'Read 'More' button that will redirect to an article page.
    3. The 'Ask Us A Question' form will be accessible in the sidebar on desktop and at the bottom of the page on mobile.

3- As a Returning Visitor, I want to find the best way to get in contact with the organisation with any questions I may have.
    1. The 'Ask Us A Question' form will be accessible in the sidebar on desktop and at the bottom of the page on mobile.
    2.  When a user inputs invalid data in the 'Ask Us A Question' form, they will be given a pop-up error above the field to assist them.
...
1- As a Frequent User, I appreciate having a user-friendly 'Ask us a question' form on the homepage that allows me to quickly submit inquiries or feedback about the website or Team Endalex's activities.
    1. The 'Ask Us A Question' form will be accessible in the sidebar on desktop and at the bottom of the page on mobile.
    2. The 'Ask Us A Question' form is styled to match the rest of the site, whilst also being a stand-out form on the homepage.
    3. The confirmation page will have a clear 'Return Home' button and a message that re-assures the user of confirmation that their question/feedback has been received.

2- As a Frequent User, I want to check to see if there are any new team-based updates on the homepage
    1. The user would already be comfortable with the website layout and can easily navigate to the homepage articles or to the individual esports team pages.
    2. The articles have the first paragraph of content and then a 'Read 'More' button that will redirect to an article page.
    3. The article pages will have an image that is related to the context of the article, as well as a clear 'Return Home' button.

3- As a Frequent User, I want to sign up to the Newsletter so that I am emailed any major updates and/or changes to the website or organisation.
    1. On the 'Store' page and 'Events' page, there will be a clear subscription form at the bottom of the page for the user to fill out.
    2. The form has validation on the field to ensure that a valid email is inputted by the user.
    3. The form leads to a confirmation page that has a message that confirms the user is subscribed, as well as having a clear 'Return Home' button.
