...
This is the main marketing website for all things Team Endalex. It is designed to be responsive and accessible on a range of devices, making it easy for potential fans to navigate.
...
Notables (regarding assessment criterias)
    File structure within project
        I would have preferred to keep image files, page html files and stylesheets all separate in order to improve organization, however GitPages was unable to work without having them all at the main branch level. 
        As per commits in the early stages of the project, I did have separate folders for different files within the project.
